                      ...
                      <form method="POST" action="{{url('/traveler/post/save') }}" enctype="multipart/form-data">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  ...
                                  <input id="name" type="text" class="form-control @error('title') is-invalid @enderror" name="from" value="{{ old('from') }}" required autocomplete="name" autofocus placeholder="From Dhaka">
                                @if($errors->has('from'))                                    
                                      <div class="text-center alert alert-danger alert-dismissable">
                                          <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
                               ...
                               <div class="col-md-6">
                                  ...
                                  <input id="name" type="text" class="form-control @error('title') is-invalid @enderror" name="to" value="{{ old('to') }}" required autocomplete="name" autofocus placeholder="Khulna">
                                @if($errors->has('to'))                                    
                                      <div class="text-center alert alert-danger alert-dismissable">
                                          <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
                                 ...
                                 <div class="col-md-4">
                                  ...
                                  <input id="name" type="number" class="form-control @error('title') is-invalid @enderror" name="amount" value="{{ old('amount') }}" required autocomplete="name" autofocus>
                                @if($errors->has('budget'))                                    
                                      <div class="text-center alert alert-danger alert-dismissable">
                                          <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
                                          <b><i class="icon fa fa-warning"></i>{{$errors->first('budget')}}</b> 
                                      </div>
                                      @endif
                              </div>
                              ...
                              <div class="col-md-4">
                               ...
                               <div class="col-md-4">
                                   ...
                                   <label for="name">Please select participate gender :</label> <br>
