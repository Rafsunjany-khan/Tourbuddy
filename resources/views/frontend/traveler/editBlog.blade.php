         ...
         <div class="col-md-12">
              <div class="card">
                  ...
                  <div class="card-body" style="background: #f3e3e3;">
                      <form method="POST" action="{{url('/traveler/blog/update') }}" enctype="multipart/form-data">
                          @csrf
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-12">
                                  ...
                                  <input id="name" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{$blog->title}}" required autocomplete="name" autofocus >
                                 ...
                                 <div class="col-md-4">
                                 <img src="{{asset('public/travelers/'.$blog->blog_image)}}" height="100px" width="150px">
                              ...
                              <div class="col-md-12">
                                  ...
                                  <div class="form-group mb-0">
                                          <div class="description-sm">
                                              <textarea id="editor1" name="details" cols="10" rows="4" required="">{{$blog->details}}</textarea>
                                          </div>
                                      </div>
