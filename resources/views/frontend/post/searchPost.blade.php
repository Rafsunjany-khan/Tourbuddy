	...
	<div class="services-2-mian py-5">
		<div class="container py-lg-5">
			...
			<div class="welcome-grids row">
				...
				<div class="col-lg-4 col-md-6 course-grid">
					<div class="course-grid-inf">
						<a href="{{url('/post/'.$data->id)}}"><img src="{{asset('public/travelers/'.$data->image)}}" class="img-fuild" alt=""></a>
           ...
           if($traveler_id>0){?>
										...
										<form action="{{route('connect.search.post')}}" method="post">
											@csrf
											<input type="hidden" name="id" value="{{$data->id}}">
											
									<span class="course-reviews" title=""><span class="fa fa-plus"
											aria-hidden="true"></span>
											<button type="submit" class="btn btn-success" style="padding: 2PX;">connect</button></span>
											</form>
										<?php } ?>
								</div>
