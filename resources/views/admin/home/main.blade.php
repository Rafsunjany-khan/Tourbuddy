        ...
        <div class="page-body">
            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="card o-hidden widget-cards">
                            <div class="bg-warning card-body">
                                <div class="media static-top-widget row">
                                    ...
                                    <div class="media-body col-8"><span class="m-0">Total post</span>
                                        <h3 class="mb-0"><span class="counter">{{$totalPost}}</span></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card o-hidden widget-cards">
                            <div class="bg-danger card-body">
                                <div class="media static-top-widget row">
                                    ...
                                    <div class="media-body col-8"><span class="m-0"> Memeber</span>
                                        <h3 class="mb-0"><span class="counter">{{$totalTraveler}}</span></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-md-6 xl-50">
                        <div class="card o-hidden  widget-cards">
                            <a href="{{url('/admin/pending/guide')}}">
                            <div class="bg-secondary card-body">
                                <div class="media static-top-widget row">
                                    <div class="icons-widgets col-4">
                                        <div class="align-self-center text-center"><i data-feather="box" class="font-secondary"></i></div>
                                    </div>
                                    <div class="media-body col-8"><span class="m-0">Apply Guide</span>
                                        <h3 class="mb-0"> <span class="counter">{{$totalPendingGuide}}</span></h3>
                                    </div>
                                </div>
                            </div>
                             </a>
